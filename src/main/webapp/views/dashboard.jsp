						...
						<div class="row">
							<div class="col-sm-6 col-md-3">
								<a href="javascript:void(0)" class="product">
									<img class="img-responsive" src="../assets/images/product-1.jpg" alt="oroduct image">
							...
							<div class="col-sm-6 col-md-3">
								<a href="javascript:void(0)" class="product">
									<img class="img-responsive" src="../assets/images/product-2.jpg" alt="oroduct image">
									<div class="product-caption clearfix">
										<span>147 Sales</span>
										<span class="pull-right">$450</span>
									</div><!-- .product-caption -->
							...
							<div class="col-sm-6 col-md-3">
								<a href="javascript:void(0)" class="product">
									<img class="img-responsive" src="../assets/images/product-3.jpg" alt="oroduct image">
									<div class="product-caption clearfix">
										<span>147 Sales</span>
										<span class="pull-right">$450</span>
									</div><!-- .product-caption -->
							...
							<div class="col-sm-6 col-md-3">
								<a href="javascript:void(0)" class="product">
									<img class="img-responsive" src="../assets/images/product-4.jpg" alt="oroduct image">
									<div class="product-caption clearfix">
										<span>147 Sales</span>
										<span class="pull-right">$450</span>
									</div><!-- .product-caption -->
